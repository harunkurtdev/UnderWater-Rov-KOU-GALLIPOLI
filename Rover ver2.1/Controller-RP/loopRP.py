...
def roboSocket(serverHost,serverPort):
    RoboSocketCom(serverHost=serverHost,serverPort=serverPort)
...
def mainLoop():
    ...
    loop.create_task(roboControl.startRoboServer())
    loop.create_task(roboOpencv.startRoboServer())
