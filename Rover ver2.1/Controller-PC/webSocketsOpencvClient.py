...
class RovCamSocketsTransfer:
    ...
    async def startRoboServerConnectCamRead(self, clientHost=None, clientPort=None, sendMessage=None):
...
if __name__ == '__main__':
    ...
    while True:
        try:
            asyncio.get_event_loop().run_until_complete(rovCamSocketsTransfer.startRoboServerConnectCamRead(clientHost="192.168.1.2", clientPort=5001,sendMessage="deneme"))
