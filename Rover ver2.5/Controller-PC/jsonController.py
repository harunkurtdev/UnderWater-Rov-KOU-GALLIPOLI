    ...
    def controlJsonWrite(self,roboSocketCom=None,joyStick=None):
        ...
        if self.joystcik==None or joyStick:
            ...
            try :
                ...
                asyncio.get_event_loop().run_until_complete(self.roboSocketCom.startRoboServerConnect(sendMessage=self.joystcikAxisValueJson(self.joystcikControllerNameSwitch(id=2),NumHatButton)))
