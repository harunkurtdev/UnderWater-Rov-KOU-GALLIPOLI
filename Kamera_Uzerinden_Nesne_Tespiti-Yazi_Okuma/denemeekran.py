...
FACE_HAAR = cv.CascadeClassifier(FACE_HAAR)

# Eye
EYE_HAAR = os.path.join("haarcascade_mcs_righteye.xml")
#EYE_HAAR = cv.Load(EYE_HAAR)

# Nose
NOSE_HAAR = os.path.join("haarcascade_mcs_nose.xml")
#NOSE_HAAR = cv.Load(NOSE_HAAR)

# Mouth
MOUTH_HAAR = os.path.join("haarcascade_mcs_mouth.xml")
