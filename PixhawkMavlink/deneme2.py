...
master = mavutil.mavlink_connection("udpin:0.0.0.0:14550")# Raspberry pi ile pixhawk'ın iletişim kurabilmesi için
# # connection olusturma
...
deger= 1900 #int(input("Deger Giriniz: ")) #pwm değeri
